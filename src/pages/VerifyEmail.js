        ...
        loading ?
          ...
          (
            <div className='max-w-[500px] p-4 lg:p-8' >
              <h2 className=' text-3xl text-richblack-5 font-semibold' >Xác minh email</h2>
              <p className='text-lg text-richblack-100 my-4 ' >Mã xác minh đã được gửi đến email của bạn <span className='font-bold' >{email}</span>. Enter the code below</p>
