        ...
        loading
          ...
          (
            <div className='w-11/12 max-w-[500px] p-4 lg:p-8 mx-auto  flex flex-col' >
              ...
              Chọn mật khẩu mới              </h2>


              <p className='text-richblack-100 my-4 text-lg leading-[1.625rem]' >
              Gần xong rồi. Nhập mật khẩu mới của bạn và bạn đã hoàn tất.              </p>
              ...
              <form onSubmit={handleOnResetPassword}>
                ...
                <label className='block relative' >
                  <p className='mb-1 mt-6 text-sm leading-[1.375rem] text-richblack-5' >Xác nhận mật khẩu mới <sup className='text-pink-200' >*</sup></p>
                  <input
                ...
                <div className='mt-6 flex flex-row gap-x-3 text-xs leading-[20px] text-caribbeangreen-300' >
                  <div className='flex flex-col gap-y-1' >
                    <div className='flex gap-x-1 items-center' >
                      ...
                      Một ký tự chữ thường                    </div>
                    <div className='flex gap-x-1 items-center' >
                      <BsFillCheckCircleFill />
                      Một ký tự viết hoa                    </div>
                    <div className='flex gap-x-1 items-center' >
                      <BsFillCheckCircleFill />
                      Một số
                    </div>
                  ...
                  <div className='flex flex-col gap-y-1' >
                    <div className='flex gap-x-1 items-center' >
                      <BsFillCheckCircleFill />
                      Một kí tự đặc biệt                    </div>
                    <div className='flex gap-x-1 items-center' >
                      <BsFillCheckCircleFill />
                      Tối thiểu 8 ký tự                    </div>
                  </div>
                </div>
