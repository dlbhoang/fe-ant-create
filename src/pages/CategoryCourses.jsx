          ...
          <div className=' bg-richblack-900 ' >
            ...
            <div className='bg-richblack-800' >
              <div className='mx-auto box-content px-10 flex flex-col gap-4 justify-center min-h-[200px] max-w-maxContentTab lg:max-w-maxContent ' >
                <p className='text-sm text-richblack-300' >Trang chủ / Chuyên mục /
            ...
            <div className='box-content mx-auto px-10 py-12 max-w-maxContentTab lg:max-w-maxContent' >
              <h2 className='text-2xl text-richblack-5 font-bold lg:text-4xl' >Các khóa học giúp bạn bắt đầu</h2>
            ...
            <div className='box-content mx-auto px-10 py-12 max-w-maxContentTab lg:max-w-maxContent'>
              ...
              Các khóa học hàng đầu ở {categoryPageData.otherCategoryCourses.name}
              </h2>
