...
const CourseDetails = () => {
  ...
  const handleAddToCart = () => {
    ...
    if (user && user.role === ROLE_TYPE.INSTRUCTOR) {
      toast.error("Người hướng dẫn không thể mua một khóa học")
      return;
    }
  ...
  const handleBuyNowClick = async () => {
    ...
    setConfirmationModalData({
      text1: 'Bạn chưa đăng nhập !!',
      text2: 'Vui lòng đăng nhập để mua khóa học này',
      btn1Text: 'Đăng nhập',
      btn2Text: 'Huỷ',
      btn1Handler: () => navigate('/login'),
      btn2Handler: () => setConfirmationModalData(null),
  ...
  const handleShare = () => {
    ...
    toast.success("Đã sao chép liên kết vào bảng nhớ tạm")
  }
  ...
  return (
    <div className='bg-richblack-900' >
...

      {
        !loading && !courseData && (
          <div className='grid place-items-center min-h-[calc(100vh-3.5rem)]' >
            <p className='text-xl text-center text-richblack-5' >Không tìm thấy khóa học như vậy</p>
          </div>
        )
      }
            ...
            <div className='bg-richblack-800 text-richblack-5 '  >
              ...
              <div className='mx-auto px-4 py-8 lg:w-[1260px] min-h-[450px]  2xl:relative' >
                ...
                <div className='mx-auto lg:mx-0 flex flex-col items-center lg:items-start max-w-maxContentTab xl:max-w-[810px]' >
                  <p className='text-sm w-full ml-5 lg:ml-0 text-left text-richblack-300' >Trang chủ / Học tập /
...
Thêm vào giỏ hàng                        </button>
                    ...
                    <div className='flex flex-col gap-y-3' >
                      ...
                      <div className='flex flex-wrap justify-between gap-2' >
                        ...
                        <div className='flex gap-1 text-sm text-richblack-200' >
                          <p>{courseData.sections.length} phần</p>
                        ...
                        <div>
                          ...
                          >
                            {openSections.length ? "Thu gọn tất cả các phần" : "Mở rộng tất cả các phần"}
                          </button>
                        </div>
                      </div>
                    </div>
            ...
            <div className='mt-8' >
              ...
              Đánh giá từ những người học khác              </h2>
