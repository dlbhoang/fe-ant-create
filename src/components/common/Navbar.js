                            ...
                            <div className='z-10 absolute top-[50%] translate-y-[3em] left-[50%] translate-x-[-50%] flex flex-col rounded-lg bg-richblack-5 p-4 text-richblack-900 transition-all duration-150 w-[200px]  lg:w-[300px] invisible  opacity-0  group-hover:visible group-hover:opacity-100 group-hover:translate-y-[1.65em]' >
...

                              {
                                catalogs.length ?
                                  ...
                                  :
                                  (<div className='select-none cursor-not-allowed' >Không có danh mục</div>)
                              }
                            </div>
                          </div>
                        )
        ...
        <div className='hidden md:flex gap-x-4 items-center' >
          {
            ...
            (
              <Link to={'/login'} >
                <button className='border border-richblack-700 bg-richblack-800 text-richblack-100 rounded-md px-3 py-2' >Đăng nhập</button>
              </Link>
            )
          }

          {
            ...
            (
              <Link to={'/signup'} >
                <button className='border border-richblack-700 bg-richblack-800 text-richblack-100 rounded-md px-3 py-2' >Đăng kí</button>
              </Link>
            )
          }
                  ...
                  <div className='px-4 text-richblack-100' >
                    {
                      catalogs.length ?
                        ...
                        :
                        (<div className='rounded-lg py-2 pl-4 select-none cursor-not-allowed' >Không có danh mục</div>)
                    }
                  </div>
                </details>
              </div>
