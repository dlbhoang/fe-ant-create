      ...
      <form className='mt-6 flex w-full flex-col gap-y-4'
        ...
        <div className='flex gap-x-4' >
          <label className='w-full' >
            <p className='mb-1 text-sm leading-[1.375rem] text-richblack-5' >Tên <sup className='text-pink-200' >*</sup></p>
            <input
              type='text'
          ...
          <label className='w-full' >
            <p className='mb-1 text-sm leading-[1.375rem] text-richblack-5' >Họ<sup className='text-pink-200' >*</sup></p>
            <input
              type='text'
              placeholder='Nhập họ'
              name='lastName'
        ...
        <div className='flex gap-x-4' >
          ...
          <label className='relative' >
            <p className='mb-1 text-sm leading-[1.375rem] text-richblack-5' >Xác nhận mật khẩu <sup className='text-pink-200' >*</sup></p>
            <input
