    ...
    <div className='' >
      <form className='mt-6 flex w-full flex-col gap-y-4'
        ...
        <label className='w-full' >
          <p className='mb-1 text-sm leading-[1.375rem] text-richblack-5' >Email <sup className='text-pink-200' >*</sup></p>
          <input
            type="email"
        ...
        <label className='w-full relative' >
          <p className='mb-1 text-sm leading-[1.375rem] text-richblack-5' >Mật khẩu <sup className='text-pink-200' >*</sup></p>
          <input
          ...
          <Link to='/forgot-password' >
            <p className=' ml-auto mt-1 max-w-max text-blue-100 text-xs'>Quên mật khẩu</p>
          </Link>
        </label>
