        ...
        <div className='p-6' >
          <div className='flex gap-x-4 justify-center items-center' >
            ...
            <div className='flex flex-col gap-y-1' >
              ...
              <p className='text-richblack-25 text-sm' >Đăng công khai</p>
            </div>
          </div>
          ...
          >
            ...
            <div className='w-11/12 flex flex-col gap-y-1 mt-2' >
              ...
              Thêm trải nghiệm của bạn <span className='text-pink-200' > *</span> </label>
              <textarea
                id='review'
                name='review'
              ...
              {
                errors.review && <p className='input-error-style !ml-2' >Hãy viết nhận xét của bạn</p>
              }
            </div>
