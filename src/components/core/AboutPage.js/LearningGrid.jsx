          ...
          >
            {
              index > 0
                ...
                <div className='flex flex-col gap-3 pb-10 lg:pb-0 lg:w-[90%]' >
                  ...
                  <p className='text-richblack-300 font-medium' >Ant&Create hợp tác với hơn 275+ trường đại học và công ty hàng đầu để mang đến các khóa học trực tuyến linh hoạt, chi phí phải chăng, và phù hợp với công việc cho cá nhân và tổ chức trên toàn thế giới.</p>
